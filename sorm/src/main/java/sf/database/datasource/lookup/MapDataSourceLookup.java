...
/**
 * Simple {@link DataSourceLookup} implementation that relies on a map for doing
 * lookups.
 * <p>
 * <p>
...
public class MapDataSourceLookup implements DataSourceLookup {
     ...
     *                    {@link String Strings}, the values are actual {@link DataSource}
     *                    instances.
     */
    ...
    /**
     * Set the {@link Map} of {@link DataSource DataSources}; the keys are
     * {@link String Strings}, the values are actual {@link DataSource} instances.
     * <p>
     * If the supplied {@link Map} is {@code null}, then this method call
    ...
    /**
     * Get the {@link Map} of {@link DataSource DataSources} maintained by this
     * object.
     * <p>
     * The returned {@link Map} is {@link Collections#unmodifiableMap(java.util.Map)
     * unmodifiable}.
     * @return said {@link Map} of {@link DataSource DataSources} (never
     * {@code null})
     */
    ...
    /**
     * Add the supplied {@link DataSource} to the map of {@link DataSource
     * DataSources} maintained by this object.
     * @param dataSourceName the name under which the supplied {@link DataSource} is to be
     *                       added
