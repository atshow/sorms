...
//		jdbcJavaTypes.put(Types.TIME_WITH_TIMEZONE, Time.class);
    ...
    static {
        ...
        // mapping.put(Types.ROWID, "String");
    ...
    public static boolean isLob(Integer sqlType) {
        if (sqlType == Types.CLOB || sqlType == Types.LONGNVARCHAR || sqlType == Types.NCLOB
                || sqlType == Types.BLOB || sqlType == Types.BINARY || sqlType == Types.VARBINARY
