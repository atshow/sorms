 ...
 * @version 2016年8月25日
 */
public class DebugOrmInterceptor implements OrmInterceptor {
    ...
    public DebugOrmInterceptor() {
    }

    public DebugOrmInterceptor(List<String> includes) {
        this.includes = includes;
    }

    public DebugOrmInterceptor(String preferredShowClass) {
        this.preferredShowClass = preferredShowClass;
    }

    public DebugOrmInterceptor(List<String> includes, String preferredShowClass) {
        this.preferredShowClass = preferredShowClass;
        this.includes = includes;
    }
    ...
    protected int lookBusinessCodeInTrace(StackTraceElement[] traces, OrmContext ctx) {
    ...
    public void after(OrmContext ctx) {
        ...
        sb.append("┗━━━━━ Debug [").append(this.getSqlId(formatSql(ctx.getSql()))).append("] ━━━").append(lineSeparator);
        println(sb.toString());
    ...
    protected List<String> formatParas(List<OrmParameter> list) {
        List<String> data = new ArrayList<String>(list.size());
        for (OrmParameter para : list) {
    ...
    protected void simpleOut(OrmContext ctx) {
        String sqlId = ctx.getSql();
        StringBuilder sb = new StringBuilder();
    ...
    protected void simpleOutException(OrmContext ctx, Exception ex) {
        String sqlId = ctx.getSql();
        StringBuilder sb = new StringBuilder();
        sb.append("--Sql Error:");
