        ...
        for (EnvURL type : envs) {
            switch (type) {
                case JAVA_CLASS_PATH:
                    for (String s : SpringStringUtils.split(System.getProperty("java.class.path"), pathSp)) {
                        add(u, s);
                    }
                    break;
                case JAVA_HOME: {
                ...
                case JAVA_LIBRARY_PATH:
                    for (String s : SpringStringUtils.split(System.getProperty("java.library.path"), pathSp)) {
                        add(u, s);
                    }
                    break;
                case PATH:
                    for (String s : SpringStringUtils.split(System.getenv("PATH"), pathSp)) {
                        add(u, s);
                    }
                    break;
                case SYSTEM_TMP:
